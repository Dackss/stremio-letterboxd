            ...
            <div>
                ...
                <div className="relative" ref={dropdownRef}>
                    <button
                        ...
                        className={`w-full bg-[#14181c] text-white border rounded-xl py-3.5 pl-5 pr-5 flex items-center justify-between transition-all duration-200 text-base shadow-inner
                            ${isDropdownOpen
                    ...
                    {isDropdownOpen && (
                        /* CORRECTION ICI : max-h-56 et overflow-y-auto pour le scroll */
                            ...
                            {SORT_OPTIONS.map((option) => {
                                ...
                                return (
                                    <button
                                        ...
                                        className={`w-full px-4 py-3 flex items-center gap-3 hover:bg-[#2c3440] transition-colors text-left
